...
(function ($) {
	...
	*/
    ...
    $("#w1").bootstrapWizard({
        ...
        onTabChange: function (tab, navigation, index, newindex) {
            ...
            $w1finish[newindex != totalTabs ? "addClass" : "removeClass"](
                "hidden"
            );
            $("#w1")
	...
	*/
    ...
    $("#w2").bootstrapWizard({
        ...
        onTabChange: function (tab, navigation, index, newindex) {
            var totalTabs = navigation.find("li").length - 1;
            $w2finish[newindex != totalTabs ? "addClass" : "removeClass"](
                "hidden"
            );
            $("#w2")
                .find(this.nextSelector)
	...
	*/
    ...
    $("#w3").bootstrapWizard({
        ...
        onTabChange: function (tab, navigation, index, newindex) {
            ...
            $w3finish[newindex != $total ? "addClass" : "removeClass"](
                "hidden"
            );
            $("#w3")
                .find(this.nextSelector)
	...
	*/
    ...
    $("#w4").bootstrapWizard({
        ...
        onTabChange: function (tab, navigation, index, newindex) {
            var $total = navigation.find("li").length - 1;
            $w4finish[newindex != $total ? "addClass" : "removeClass"](
                "hidden"
            );
            $("#w4")
                .find(this.nextSelector)
	...
	*/
    ...
    $("#w5").bootstrapWizard({
        ...
        onTabChange: function (tab, navigation, index, newindex) {
            var $total = navigation.find("li").length - 1;
            $w5finish[newindex != $total ? "addClass" : "removeClass"](
                "hidden"
            );
            $("#w5")
                .find(this.nextSelector)
